# VideoWindow Electron

Desktop application for [VideoWindow] built with [Electron].

![](screenshot.png)

## Features

- Works with any VideoWindow deployment
- Local settings
...
### Using it with your own VideoWindow installation

In order to use this application with your own VideoWindow installation it's
